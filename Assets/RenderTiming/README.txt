...
Quick start
-----------
1. add the RenderTiming component to a suitable singleton object in your scene
2. reference `RenderTiming.instance.deltaTime` from your in-app debug
overlay, etc.
...
Directory
---------
This project is hosted at https://github.com/google/render-timing-for-unity
